...
namespace nana
{
	nana::color to_color(const std::string& s);		///< Returns nana::color from the given property color string
	bool is_color_inherited(const std::string& s);	///< Returns the inherited value (true/false) from the given property color string
	...
	std::string to_string(const nana::color& c, bool inherited = false);	///< Returns property color string from the given nana::color and inherited state
